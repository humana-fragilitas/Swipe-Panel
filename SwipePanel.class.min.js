...
c.push(g.userSelect+": none;");c.push("z-index: "+(e.swipePanelZIndex+1)+";");f.push("border-top-left-radius: 0;");f.push("border-top-right-radius: 0;");f.push("border-bottom-left-radius: 4px;");f.push("border-bottom-right-radius: 4px;");f.push("text-shadow: 0 -1px ");f.push(e.swipePanelLabelColours[2]+";");f.push("box-shadow: 0 2px 4px rgba(0,0,0,.5),");f.push("0 1px 1px rgba(0,0,0,.2),");f.push("0 1px 1px #333333 inset;");d.push("border-top-left-radius: 4px;");d.push("border-top-right-radius: 4px;");
...
"msTransition"in l&&"msTransform"in l?{domTransition:"msTransition",transition:"-ms-transition",transform:"-ms-transform",domTransform:"msTransform",radialGradient:"-ms-radial-gradient",repeatingLinearGradient:"-ms-repeating-linear-gradient",translate:"translate",userSelect:"-ms-user-select"}:{domTransition:"transition",transition:"transition",transform:"transform",domTransform:"transform",radialGradient:"radial-gradient",repeatingLinearGradient:"repeating-linear-gradient",translate:"translate",userSelect:"user-select"};
